...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (clicked.equals("CS") || clicked.equals("IT")) {
            ...
            customAdapter = new CustomAdapter(personNames, emailIds, mobileNumbers, MainActivity2.this);
            ...
            recyclerView = findViewById(R.id.recyclerView2);
            customAdapter = new CustomAdapter(roomList, wingList, floorList, MainActivity2.this);
    ...
    private void filterList(String query) {
        ...
        customAdapter = new CustomAdapter((ArrayList<String>) filteredNames, (ArrayList<String>) filteredEmails, (ArrayList<String>) filteredMobileNumbers, MainActivity2.this);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        if (!roomList.isEmpty() && !wingList.isEmpty() && !floorList.isEmpty()) {
            ...
            customAdapter = new CustomAdapter(filteredRooms, filteredWings, filteredFloors, MainActivity2.this);
            recyclerView.setAdapter(customAdapter);
            recyclerView.setLayoutManager(new LinearLayoutManager(this));
        }
    }
